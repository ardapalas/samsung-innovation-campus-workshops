...
Tue | 20-min bodyweight circuit (no gym)    | Add veg to lunch            | 10-min sunlight before study
... | ...                                   | ...                         | ...
...
------------------------------|-----------|----------------------------------------
≤3 focused hours/day          | Yes       | All days ≤3 blocks
≥2 rest/light days            | Partial   | Only 1 clear light day in first output
Missed-day fallback present   | Yes       | Survival note included
≤2 subjects/day               | Yes       | Never exceeded
```
